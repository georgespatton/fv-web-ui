...
package ca.firstvoices.widgets.services;
...
public class WidgetsServiceImplTest extends AbstractFirstVoicesDataTest {

  @Inject protected WidgetService widgetService;
  ...
  public void trimWhitespaceTest() {
    ...
    widgetService.sanitizeDocument(session, testWord);
    widgetService.sanitizeDocument(session, testPhrase);
