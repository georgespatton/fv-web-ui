...
public class ListsTestUtils {
  private ListsTestUtils() {
  ...
  public static boolean requiredJobFired(CapturingEventListener capturingEventsListener, String requiredJob) {
    ...
    Event addToRequiredJobsEvent = ListsTestUtils.getAddToRequiredJobsEvent(capturingEventsListener);
