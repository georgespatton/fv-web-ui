...
package ca.firstvoices.lists.services;
...
@Deploy({"FirstVoicesLists:OSGI-INF/services/sanitizeDocument-contrib.xml"})
public class ListsServiceImplTest extends AbstractFirstVoicesDataTest {

  @Inject protected ListService sanitizeDocumentService;
