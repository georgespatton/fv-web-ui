...
const PageDialectLearnPhrases = React.lazy(() => import('components/Phrases'))
...
const PageDialectViewAlphabet = React.lazy(() => import('components/Alphabet/'))
const PageDialectViewCharacter = React.lazy(() => import('components/Alphabet/view'))
...
const PageDialectLearnPhrasesByPhrasebook = React.lazy(() => import('components/Phrases/phrasesFilteredByPhrasebook'))
...
const PageSearch = React.lazy(() => import('components/Search'))
...
const PageDialectPhraseEdit = React.lazy(() => import('components/Phrases/Edit'))
...
const PageDialectPhrasesCreate = <div>test</div> // React.lazy(() => import('components/Phrases/Create'))
